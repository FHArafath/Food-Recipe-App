    ...
    for (let meal of meals) {
        document.querySelector(".meal-wrapper").innerHTML += `
            <div class="meal-box border border-gray-500 rounded-xl">
                <img src=${meal.strMealThumb} alt=${meal.strMeal} class="rounded w-full h-[200px] object-cover">
                <div class="p-3">
                    <h3 class="heading">${meal.strMeal}</h3>
                    <p class="text-gray-400 my-2"> ${meal.strInstructions.slice(0, 90)} ... </p>
...
function showMealDetails(meal){
    ...
    details.innerHTML = `
     <div class="popup bg-white w-[70%] min-h-[500px] p-10">
                    ...
                    <a href=${meal.strYoutube}><button class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Watch</button></a>
                    <button class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded" onclick="closeDetails()">Close</button>
                </div>
    `
}
